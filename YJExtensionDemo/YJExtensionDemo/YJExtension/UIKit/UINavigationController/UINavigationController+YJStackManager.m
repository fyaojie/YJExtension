//
//  UINavigationController+YJStackManager.m
//  YJExtensionDemo
//
...
@implementation UINavigationController (YJStackManager)
/**
...
{
    return [self popToViewController:[self yj_findViewController:className] animated:YES];
}
/**
 *  @brief  pop n层
 *
