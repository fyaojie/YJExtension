...
@implementation NSString (YJSimilarity)

- (CGFloat)yj_scoreAgainst:(NSString *)otherString{
    return [self yj_scoreAgainst:otherString fuzziness:nil];
}

- (CGFloat)yj_scoreAgainst:(NSString *)otherString fuzziness:(NSNumber *)fuzziness{
    return [self yj_scoreAgainst:otherString fuzziness:fuzziness options:YJScoreOptionNone];
}

- (CGFloat)yj_scoreAgainst:(NSString *)anotherString fuzziness:(NSNumber *)fuzziness options:(YJScoreOption)options{
    ...
    if(YJScoreOptionFavorSmallerWords == (options & YJScoreOptionFavorSmallerWords)){
    ...
    if(YJScoreOptionReducedLongStringPenalty == (options & YJScoreOptionReducedLongStringPenalty)){
